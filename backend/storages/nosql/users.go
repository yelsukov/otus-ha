...
// TODO remove repeatable code
func (m *UsersStorage) Fetch(_ [][2]string, offset, limit uint32) ([]models.User, error) {
	resp, err := m.tt.Select("users", nil, offset, limit, tarantool.IterAll, nil)
	if err != nil {
		return nil, err
	}
